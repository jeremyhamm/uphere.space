<template>
  <div>
        ...
        <b-row no-gutters class="title">
          <b-col cols="12" class="text-center justify-content-center">
            ...
            <img
              ...
              alt="uphere.space"
            />
            <h3 class="mt-3 mb-5 text-center">Realtime tracking and predictions for thousands of satellites currently orbiting earth</h3>
          </b-col>
        </b-row>
        <!-- Satellite List -->
    ...
    <b-row no-gutters class="justify-content-center mt-5">
      <b-col cols="12">
        <h4 class="text-center">Most popular satellites today {{formatDate()}}</h4>
      </b-col>
    </b-row>
